...
public class ModOverworldBiomes {
    ...
    public static Biome mixedRedwoodForest(
        ...
        // Small, medium, and giant trees
        gen.feature(GenerationStep.Feature.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_REDWOOD_PLACED_KEY);
        gen.feature(GenerationStep.Feature.VEGETAL_DECORATION, ModPlacedFeatures.MEDIUM_REDWOOD_PLACED_KEY);
        gen.feature(GenerationStep.Feature.VEGETAL_DECORATION, ModPlacedFeatures.GIANT_SEQUOIA_PLACED_KEY);
